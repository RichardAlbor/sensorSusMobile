...
import com.sensorsus.Utils.AndroidUtil;
import com.sensorsus.adapter.ExtrasAdapter;
...
public class ItemDetailsActivity extends AppCompatActivity implements ExtrasAdapter.OnExtraClickListener {
    ...
    private void initComponents() {
        ...
        mPlace = findViewById(R.id.btn_user_avaliacao_item_tetails);
        ...
        mOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    sendIntent.putExtra(Intent.EXTRA_TEXT, getResources().getString(R.string.ask_for_food_begin) + " Avalia\u00E7\u00E3o XYZ " + getResources().getString(R.string.ask_for_food_extras) + "\n" + "- Queijo e\n- Bacon");
                    sendIntent.setType("text/plain");
                    sendIntent.putExtra("jid", formattedNumber +"@s.whatsapp.net");
                    startActivity(sendIntent);
                } catch (Exception e) {
                    Toast.makeText(getApplicationContext(), "Você não possui privilégio de gestor", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
